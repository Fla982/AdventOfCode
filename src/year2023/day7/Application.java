	            ...
	            public int compare(Hand left, Hand right) {
	                ...
	                for(int i = 0; i < 5; i++) {
	                    if(right.hand.charAt(i)==left.hand.charAt(i))
	                        continue;
	                    System.out.println("h: " + right.hand + " h2: " + left.hand);
	                    ...
	                    return Integer.compare((left.order).indexOf(left.hand.charAt(i)) ,(left.order).indexOf(right.hand.charAt(i)));
